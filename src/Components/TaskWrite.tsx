...
export const TaskWrite = (props:AddButtonProps) => {
  ...
  return (
    ...
    <div className='Taskwrite'>
        <input type="text" className='InputText' placeholder='write your next task' value={text} onChange={(e) => setText(e.target.value)}/>
        
        <button className='addTaskButton' onClick={handleAddClick} disabled={text.trim() === ""}>
          <AddTaskButtonSvg/>
    </button>
